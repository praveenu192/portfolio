            ...
            <div className="hero-container grid-2">
                <div className="hero-content">
                    ...
                    <div className="hero-cta reveal-text">
                        ...
                        <a href="/Praveen U CSE-IV year.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary magnetic" style={{ borderColor: 'var(--primary)', color: 'var(--primary)' }}>
